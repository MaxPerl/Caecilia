...
if(p_v.second)
ov_def(v)}}
of()},draw_symbols:function(of,p_voice){var s,s2,nl,y,C=abc2svg.C,abc=this,dot="\ue1e7",anno_a=abc.anno_a,staff_tb=abc.get_staff_tb(),out_svg=abc.out_svg,out_sxsy=abc.out_sxsy,xypath=abc.xypath
